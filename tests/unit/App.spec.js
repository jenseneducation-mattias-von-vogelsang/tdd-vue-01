...
describe('User loads the page(component)', () => {
...
describe('User clicks button to increase', () => {
  test('Clicking the button increments value on each click', async () => {
...
describe('User clicks button to decrease', () => {
  test('Clicking the button decreases the value with -1 with each click', async () => {
    // The render method returns a collection of utilities to query your component.
    const {
      getByText
    } = render(ButtonIncrement);
...
describe('User has several options, and selects one of them', () => {
...
describe('User loads the component', () => {
...
describe('User types in text into input, adds the ToDo then can manage them', () => {
  test('Take value from input, then add it as todo. Check if item gets sent to index 0 when a button next to ToDo is clicked', async () => {
    ...
    //Find all li elements and put in array, then bind element at index 0 in that array
    ...
    //Find all li's again in new array
